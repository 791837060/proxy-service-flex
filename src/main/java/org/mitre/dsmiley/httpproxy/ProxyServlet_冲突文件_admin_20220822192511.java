...
public class ProxyServlet extends HttpServlet {
  ...
  protected void service(HttpServletRequest servletRequest, HttpServletResponse servletResponse)
    ...
    try {
      ...
      InputStream inputStream = logPrint(proxyResponse);
  ...
  private InputStream logPrint(HttpResponse proxyResponse) throws IOException {
    ...
    WritingFile.appendFile("/Users/zenghuikang/workspace/swaggerul/httpProxyer_ulwfcyvi/proxyservice/src/main/resources/request_log.txt","----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------\n",true);
  ...
  protected HttpRequest newProxyRequestWithEntity(String method, String proxyRequestUri,
    ...
    String parJson = toPrettyFormat(par.toString());
    System.out.println("body:"+parJson);
...
Accept,application/json, text/plain, *\/*
    ...
    System.out.println(df.format(new Date()) + "  getRequestLine==>  "+proxyRequest.getRequestLine());
  ...
  private String headerGoogle(String name){
      String A ="/Users/zenghuikang/Downloads";
